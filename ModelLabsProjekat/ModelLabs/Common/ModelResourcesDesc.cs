...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.TERMINAL_CONDUCTINGEQUIPMENT);
			notSettablePropertyIds.Add(ModelCode.TERMINAL_CONNECTIVITYNODE);
			notSettablePropertyIds.Add(ModelCode.ACLINESEGMENT_PERLENGTHIMPEDANCE);
