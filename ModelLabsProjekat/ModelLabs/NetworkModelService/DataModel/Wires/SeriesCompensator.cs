...
namespace FTN.Services.NetworkModelService.DataModel.Wires
{
    public class SeriesCompensator : Core.ConductingEquipment
    {
        ...
        public override bool HasProperty(ModelCode property)
        {
            switch (property)
            {
                case ModelCode.SERIESCOMPENSATOR_R_RESISTANCE:
                case ModelCode.SERIESCOMPENSATOR_R0_RESISTANCE:
                case ModelCode.SERIESCOMPENSATOR_X_RESISTANCE:
                case ModelCode.SERIESCOMPENSATOR_X0_RESISATANCE:
                    return true;
